...
\begin{frame}
    \begin{threeparttable}
        ...
        \begin{tabular}{ p{0.27\linewidth} p{0.08\linewidth} p{0.08\linewidth} p{0.08\linewidth} p{0.08\linewidth} p{0.08\linewidth} p{0.08\linewidth}}
            ...
            \midrule
            AP\_pass\_pct &  136.0  &  0.43 & 0.23 & 0.05 & 0.84 & 4\%  \\ 
            enroll\_Disadvantaged &  63.0  &  0.36 & 0.19 & 0.07 & 0.85 & 56\%   \\
            enroll\_All &  42.0  &  0.63 & 0.17 & 0.34 & 0.95 & 70\%  \\
            CTE\_cred\_pct &  19.0  &  16.26 & 14.95 & 0.0 & 54.0 & 87\%  \\ 
            total\_counselors &  142.0  &  440.77 & 46.77 & 361.0 & 508.0 & 0\% \\
            int\_employ &  142.0  &  11.24 & 2.66 & 8.3 & 15.0 & 0\%  \\
            int\_tradesch &  142.0  &  0.9 & 0.15 & 0.7 & 1.1 & 0\%  \\ 
            int\_commcoll &  142.0  &  33.81 & 1.92 & 31.3 & 36.9 & 0\% \\
            int\_pubsr &  142.0  &  40.58 & 1.48 & 38.4 & 43.4 & 0\%  \\
            \midrule
        \end{tabular}
...
\begin{frame}{Hypothesis Validation}
    ...
    \begin{block}{Limited Career and Technical Education Data}
        \begin{itemize}
            \item[$\triangleright$] CTE Credentials 
            \item[$\triangleright$] CTE Enrollment
        \end{itemize}
    \end{block}

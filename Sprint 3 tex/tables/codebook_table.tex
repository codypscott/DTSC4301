...
\label{tab:codebook2} %% use this to refer to the table within the paper (I think a link will open up)
    \begin{tabular}{ p{0.23\linewidth} p{0.115\linewidth} p{0.13\linewidth} p{0.49\linewidth}}     %% 5 columns, all centered. the tabular environment begins the actual table.    
    \toprule %% A line across the top
    Variable                        & \multicolumn{3}{c}{Information} \\ %% The titles of the columns. 
